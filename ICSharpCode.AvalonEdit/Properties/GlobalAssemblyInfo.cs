...
[assembly: AssemblyInformationalVersion(RevisionClass.FullVersion + "-0a3343d2")]
...
internal static class RevisionClass
{
	...
	public const string Revision = "7916";
	public const string VersionName = null;
	
	public const string FullVersion = Major + "." + Minor + "." + Build + ".7916";
}
